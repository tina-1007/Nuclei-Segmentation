...
import numpy as np
import pycococreatortools.pycococreatortools as cocotools
    ...
    for stage in stages:
        ...
        for root, _, files in os.walk(IMAGE_DIR):
            ...
            for image_filename in image_files:
                ...
                image_info = cocotools.create_image_info(
                ...
                for root, _, files in os.walk(ANNOTATION_DIR):
                    ...
                    for annotation_filename in annotation_files:
                        ...
                        annotation_info = cocotools.create_annotation_info(
                ...
                image_id = image_id + 1
        output_name = 'annotations/test_nucleus_{}.json'.format(stage)
